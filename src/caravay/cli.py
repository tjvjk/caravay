"""Command-line entry point for Caravay."""
...
from caravay import execution, live, transcription
from caravay.artifacts import HASHES, threshold
from caravay.models import DownloadError, DownloadLockError, download, inspect
from caravay.settings import LANGUAGES, InvalidConfigError, Settings, load
from caravay.translation import (
    FORMAT,
    Issue,
    Outcome,
    Result,
...
def parser() -> argparse.ArgumentParser:
    ...
    result = argparse.ArgumentParser(prog="caravay")
...
def main() -> int:
    """Run the Caravay command-line interface."""
