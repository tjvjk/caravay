...
stdin to `caravay translate` and receive English text through the installed pinned
...
**State:** closed
**Closed by:** https://github.com/tjvjk/caravay/pull/3

- [x] `caravay translate [OPTIONS] [TEXT_FILE|-]` accepts at most one operand;
