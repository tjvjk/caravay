...
- [ ] The command produces deterministic output and outcomes for fixed input,
      backend, model revision, and dependency lock.
- [ ] Subprocess tests exercise composed success and every outcome transition,
...
- [ ] An opt-in real-model smoke test translates a short Source Armenian audio
