...
languages; the user does not select a source language and Caraway does not claim
...
- [ ] `caraway live --route fused --target eng --input-format f32le -` selects
...
- [ ] A meeting may switch source language at a finalized segment boundary without
      restarting Caraway or changing flags. Each segment is translated to English
